...
class TestEmbeddingStatus:
    def test_status_no_config(self):
        ...
        assert "No active embedding model configuration found" in data.get(
            "message", ""
        )
    ...
    def test_status_lmstudio_success(self, mock_get):
        ...
        EmbeddingModelConfig.objects.create(
            ...
            model_provider=EmbeddingProvider.LMSTUDIO,
            is_active=True,
        )
        ...
        assert data["provider"] == EmbeddingProvider.LMSTUDIO
